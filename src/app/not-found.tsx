  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      <div className="relative mb-8 flex items-center justify-center">
        ...
        <Search
          className="absolute -bottom-2 -right-2 h-8 w-8 text-accent"
          strokeWidth={1.5}
        />
      </div>
      ...
      <p className="mb-8 max-w-lg text-lg text-muted-foreground">
        We've looked under the cushions and behind the cabinets, but we can't
        find the page you're looking for.
      </p>
      <div className="flex flex-col justify-center sm:flex-row gap-4">
        <PremiumButton href="/">Return to Homepage</PremiumButton>
        <PremiumButton href="/products/new-arrival/all" variant="secondary">
          Browse Products
        </PremiumButton>
      </div>
    </div>
